...
export const ReactFlowWrapper = () => {
  ...
  return (
    <div className="w-full h-screen grid grid-cols-[min-content_auto] grid-rows-[5fr] bg-[#E3F2FD] ">
      <Sidebar />
      <div style={{ width: "84vw", height: "100vh", overflowY: 'scroll' }} ref={reactFlowWrapper}>
        <ReactFlow
          nodes={nodes}
          edges={edges}
        ...
        >
          <MiniMap zoomable pannable style={{ backgroundColor: '#2171b5' }} />
          <Controls />

          <Background variant="dots" gap={12} size={1} style={{ backgroundColor: '#E3F2FD' }} />
        </ReactFlow>
        ...
        <div id="demo-content"
          style={{ maxHeight: '100vh', minWidth: '300px', height: 'min-content', backgroundColor: 'white', borderRadius: '10px', width: 'min-content', position: 'absolute', top: '90px', right: '20px', padding: '20px', boxShadow: '0 4px 12px rgba(0, 0, 0, 0.15)' }} > demo content</div>
      </div>
