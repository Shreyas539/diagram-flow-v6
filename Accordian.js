...
const FileItem = ({ name }) => (
    <div >
        {/* if(file name = flow){
            render a button which on click displays json
        }else{
            render a normal file
        } */}
        {name !== 'flow' ?
            ...
            <div>
                <button style={{ whiteSpace: 'nowrap' }} className='sub-menu' onClick={() => {
    ...
    return (
        <div className="app-container">
            <div className="accordion-card">
                <h4 className="text-2xl font-bold mb-3" >Tree view</h4>
